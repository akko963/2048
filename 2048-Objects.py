...
#takes the myList(which contains the xyz in each block), move them accordinly and return updated list)
#calls addMatrix for actual processing
...
# process adding for myList(which contains the xyz in each block), and return updated list)
...
def main():
    global locked, Total, fpsClock, _GameEnd
    locked=[]
    Total = 0
